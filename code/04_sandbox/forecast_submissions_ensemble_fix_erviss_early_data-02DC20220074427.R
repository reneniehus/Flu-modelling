...
# look at ECDC forecast submissions
mod_log = read_csv(
  file=paste0(
...
# loadingg the covid forecasting hub ensemble in order to fix this manually
...
# understand data the Nick shared prior to ERVISS release
######################
