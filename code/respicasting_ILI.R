...
for (i_trans in tranv_v) { # run same model for diff scaling
  ...
  if (mytransformation=="sqrt") write_csv( respicast_df , file=paste0("./output/flu-forecast-hub/ECDC-norrsken_blue/",myorigin,"-ECDC-norrsken_blue.csv") )
...
if (F){
  ...
  library(hubVis)
  mod_log = read_csv(file="./output/flu-forecast-hub/ECDC-norrsken_green/2023-12-20-ECDC-norrsken_green.csv")
  mod_sqrt = read_csv(file="./output/flu-forecast-hub/ECDC-norrsken_blue/2023-12-20-ECDC-norrsken_blue.csv")
